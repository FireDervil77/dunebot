...
sudo cp fail2ban-dunebot-exploits.conf /etc/fail2ban/filter.d/dunebot-exploits.conf
echo "✅ Filter installiert"

# 3. Kopiere Jail
echo "📄 Kopiere Jail nach /etc/fail2ban/jail.d/..."
sudo cp fail2ban-jail-dunebot.conf /etc/fail2ban/jail.d/dunebot.local
