...
class TicketBotPlugin extends BotPlugin {
    ...
    async onGuildDisable(guildId) {
        ...
        try {
            ...
            await this.dbService.query('DELETE FROM ticket_transcripts WHERE guild_id = ?', [guildId]);
            await this.dbService.query('DELETE FROM tickets WHERE guild_id = ?', [guildId]);
            await this.dbService.query('DELETE FROM ticket_categories WHERE guild_id = ?', [guildId]);
            await this.dbService.query('DELETE FROM ticket_settings WHERE guild_id = ?', [guildId]);
