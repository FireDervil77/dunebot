        ...
        try {
            ...
            if (guildId) {
                ...
                try {
                    ...
                    if (pluginManager && pluginManager.plugins && pluginManager.plugins.get('core')) {
                        const corePlugin = pluginManager.plugins.get('core');
                        ...
                        Logger.success(`[Core Migration 6.6.0] Navigation aktualisiert: ${navCount.count} Einträge`);
                    } else {
                        ...
                        const navItems = [
                            ...
                            { title: 'NAV.PERMISSIONS', url: `/guild/${guildId}/permissions`, icon: 'fa-solid fa-user-lock', order: 2500, parent: null },
                            { title: 'NAV.PERMISSIONS_USERS', url: `/permissions/users`, icon: 'fa-solid fa-users', order: 10, parent: `/guild/${guildId}/permissions` },
                            { title: 'NAV.PERMISSIONS_GROUPS', url: `/permissions/groups`, icon: 'fa-solid fa-users-cog', order: 20, parent: `/guild/${guildId}/permissions` },
                            { title: 'NAV.PERMISSIONS_MATRIX', url: `/permissions/matrix`, icon: 'fa-solid fa-table', order: 30, parent: `/guild/${guildId}/permissions` },
