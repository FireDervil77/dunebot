...
const { MiscUtils, EmbedUtils } = require("dunebot-sdk/utils");
 ...
 * @param {import('dunebot-sdk').CommandType} cmd
 * @param {string} prefix
 */
 ...
 * @param {import('dunebot-sdk').CommandType} cmd - command object
 ...
 * @param {import('dunebot-sdk').ContextType} context
 */
