...
- Du brauchst die Berechtigung **Server verwalten** auf dem Discord-Server, zu dem du den Bot hinzufügen möchtest
- Ein Discord-Account (logisch!)
...
3. Der Server-Besitzer bekommt automatisch die Administrator-Gruppe
4. Das Core-Plugin wird aktiviert

## Nächster Schritt

Öffne jetzt das [Dashboard](../dashboard/uebersicht.md), um deinen Server zu konfigurieren.

→ Weiter: [Erste Schritte](erste-schritte.md)
