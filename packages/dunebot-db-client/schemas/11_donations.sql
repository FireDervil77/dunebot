-- ============================================================================
-- Donations - Kern-Feature: Stripe + PayPal + Manuelle Donations
-- Verschoben aus SuperAdmin Plugin → Kern (benötigt kein Plugin-Scope)
-- ============================================================================
CREATE TABLE IF NOT EXISTS donations (
    ...
    is_recurring TINYINT(1) DEFAULT 0 COMMENT '0 = Einmalig, 1 = Monatlich',
    recurring_until DATE COMMENT 'Bis wann läuft die recurring Donation',
    anonymous TINYINT(1) DEFAULT 0 COMMENT 'Anonyme Spende',
  ...
  COMMENT='Alle Donations (Stripe, PayPal, Manuell)'
