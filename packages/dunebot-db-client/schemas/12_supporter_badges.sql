-- ============================================================================
-- Supporter Badges - Kern-Feature: Badge-Level basierend auf Donations
-- Verschoben aus SuperAdmin Plugin → Kern
-- ============================================================================
CREATE TABLE IF NOT EXISTS supporter_badges (
    ...
    is_recurring TINYINT(1) DEFAULT 0 COMMENT 'Aktiver monatlicher Supporter',
    recurring_amount DECIMAL(10,2) DEFAULT 0.00,
    badge_visible TINYINT(1) DEFAULT 1 COMMENT 'Badge im Dashboard anzeigen',
    is_active TINYINT(1) DEFAULT 1 COMMENT 'Badge ist aktiv',
  ...
  COMMENT='Supporter-Badges basierend auf Donations'
